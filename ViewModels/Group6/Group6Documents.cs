namespace CarManufactoring.ViewModels.Group6
{
    public class Group6Documents
    {
        ...
        public readonly static List<Documents> GroupDocuments = new List<Documents>() {
            ...
            new Documents {Name = "Diagrama de Caso de Uso ", From = "João Aleixo",DocPath="/documents/Group6/JoaoAleixo/DiagramaCasosUsoAtualizado.pdf"},
            new Documents {Name = "Diagrama de Sequencia ", From = "João Aleixo",DocPath="/documents/Group6/JoaoAleixo/Diagrama de Sequencia.pdf"},
