...
namespace CarManufactoring.Migrations
{
    ...
    [Migration("20221210185651_MachineBudget")]
    partial class MachineBudget
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarManufactoring.Models.CarModels", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CarModel_Id"), 1L, 1);
            ...
            modelBuilder.Entity("CarManufactoring.Models.MachineAquisition", b =>
                {
                    ...
                    b.Property<DateTime>("QuantityOfParts")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("CarManufactoring.Models.MachineBudget", b =>
                {
                    b.HasOne("CarManufactoring.Models.MachineAquisition", "Aquisition_FK")
                        .WithMany()
                        .HasForeignKey("Aquisition_FKMachineAquisitionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarManufactoring.Models.Supplier", "Supplier_FK")
                        .WithMany()
                        .HasForeignKey("Supplier_FKSupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Aquisition_FK");

                    b.Navigation("Supplier_FK");
                });
