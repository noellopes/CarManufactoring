...
namespace CarManufactoring.ViewModels.Group2 {
    public class CarPartsList {
        ...
        public readonly static List<CarParts> CarPart = new List<CarParts>() {
            ...
            new CarParts{ ProductId = 2, Name="Junta, parafusos da tampa da das válvulas ELRING", PartType="motor compartment", Reference="560.490 ", PointOfPurchase=1800, SafetyStock=600, LevelService= 0.3M}
