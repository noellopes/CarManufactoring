...
namespace CarManufactoring.Migrations
{
    ...
    [Migration("20221222175255_MToMCarConfigStockProduct")]
    partial class MToMCarConfigStockProduct
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarManufactoring.Models.ModelParts", b =>
                {
                    ...
                    b.HasKey("StockProductId", "CarConfigId");
            ...
            modelBuilder.Entity("CarManufactoring.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("CarManufactoring.Models.StockProduct", b =>
                {
                    b.Property<int>("StockProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StockProductId"), 1L, 1);
            ...
            modelBuilder.Entity("CarManufactoring.Models.CarParts", b =>
                {
                    b.HasBaseType("CarManufactoring.Models.Product");
                    ...
                    b.HasDiscriminator().HasValue("CarParts");
                });
            ...
            modelBuilder.Entity("CarManufactoring.Models.ModelParts", b =>
                {
                    ...
                    b.HasOne("CarManufactoring.Models.StockProduct", "StockProduct")
                        .WithMany("CarConfig")
            ...
            modelBuilder.Entity("CarManufactoring.Models.StockProduct", b =>
                {
                    b.HasOne("CarManufactoring.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarManufactoring.Models.Stock", "Stock")
                        .WithMany()
