...
namespace CarManufactoring.Data
{
    public static class SeedData
    {
        ...
        private static void PopulateStocks(CarManufactoringContext db)
        {
            ...
            db.Stock.AddRange(
                new Stock { Quantity = 35.0, Location = "Warehouse 2", MaterialId = 1, CollaboratorId = 1 },
                new Stock { Quantity = 10.0, Location = "Warehouse 1", MaterialId = 2, CollaboratorId = 1 },
                new Stock { Quantity = 52.0, Location = "Warehouse 4", MaterialId = 3, CollaboratorId = 1 }
                ) ;
