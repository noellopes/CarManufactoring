...
namespace CarManufactoring.Controllers
{
    public class CollaboratorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CollaboratorId,Name,BirthDate,Phone,Email,Available")] Collaborator collaborator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CollaboratorId,Name,BirthDate,Phone,Email,Available")] Collaborator collaborator)
        {
